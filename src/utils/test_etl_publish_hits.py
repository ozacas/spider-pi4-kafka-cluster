...
def test_process_hit_success():
   ...
   assert db.method_calls == [mock.call.count_by_function.find_one({'url': 'https://some.web.site/somewhere.js'}),
                              mock.call.etl_hits.insert_one({'control_url': 'https://cdn.com/path/to/artefact.js', 
